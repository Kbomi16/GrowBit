...
import { FiUser, FiLogOut, FiUsers, FiEdit2 } from 'react-icons/fi'
      ...
      <div className="flex flex-col rounded-lg bg-white p-6 shadow-md">
        ...
        <div className="mb-4 flex justify-around border-b border-gray-300">
          <button
            ...
            className={`flex items-center p-2 ${activeTab === 'profile' ? 'border-b-2 border-green-30 font-bold text-green-30' : 'text-gray-500'}`}
          >
            <FiUser className="mr-2" /> 프로필
          </button>
          <button
            onClick={() => setActiveTab('friends')}
            className={`flex items-center p-2 ${activeTab === 'friends' ? 'border-b-2 border-green-30 font-bold text-green-30' : 'text-gray-500'}`}
          >
